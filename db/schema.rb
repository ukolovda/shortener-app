...
ActiveRecord::Schema.define(version: 2019_10_31_065741) do
  ...
  create_table "simple_url_clicks", force: :cascade do |t|
    t.bigint "simple_url_id"
    t.string "ip"
    t.datetime "clicked_at", null: false
    t.index ["simple_url_id"], name: "index_simple_url_clicks_on_simple_url_id"
  end
